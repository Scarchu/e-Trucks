...
define("TCLANINS_0", "Управление на камиони");
define("TCLANINS_1", "Този модул ще направи свирка");
define("TCLANINS_2", "Конфигурирай Управление на камиони");
define("TCLANINS_3", "За конфигуриране моля кликнете линка в секция Модули от началната админ страница");