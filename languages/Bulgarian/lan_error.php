...
define("LAN_ERROR_20", "Моля, кликнете тук за заглавната страница на сайта");
...
define("LAN_ERROR_28", "[4]: Не е намерено резервно копие на ядрото. Моля, стартирайте <a href='resetcore/resetcore.php'> Reset_Core </a> програмата, за да възстанови вашите основни настройки. <br />След възстановяването на ядрото, моля запишете backup от admin/SQL страница.");
...
define("LAN_ERROR_31", "[7]: MySQL работи, но  не мога да се свържа с базата данни(). <br /> Моля, проверете дали наистина съществува и че вашият e107_config.php съдържа точна информация.");
